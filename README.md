...
This project performs image segmentation on MRI brain image to identify and segement tumor regions using binary masking and labeling techniques in Python.
